...
- **[User Guide (FR)](https://mirabellebenou.github.io/dcs-briefing-generator/docs/DCS_World_Briefing_Generator_User_Guide.html)** — Full user documentation in French
